...
const DiscordButton: React.FC<DiscordButtonProps> = ({
                                                         inviteLink = 'https://discord.gg/ukDMHn6YT9',
                                                         memberCount = 186
                                                     }) => {
    ...
    return (
        <div
            className={`${styles.container} ${glitching ? styles.glitching : ''} ${hovering ? styles.hovering : ''}`}
            ...
            <div className={styles.button}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.usersOnline}>
                        ...
                        <div className={styles.onlineText}>{memberCount} MEMBERS</div>
                    </div>
                </div>

                <div className={styles.copyButton} onClick={copyInvite}>
                    {copied ? 'COPIED!' : 'COPY'}
                </div>
            </div>
